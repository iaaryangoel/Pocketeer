  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-100 to-purple-100 flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-8 text-center">
        <img
          src="https://cdn-icons-png.flaticon.com/512/4376/4376981.png"
        ...
        <p className="text-lg text-gray-600 max-w-2xl">
          Take control of your spending, track expenses, and save more with our
          intuitive personal finance manager.
        </p>
        <button
          className="mt-8 px-6 py-3 bg-purple-600 hover:bg-purple-700 text-white text-lg font-semibold rounded-full shadow-lg transition duration-300"
      ...
      {/* Features Section */}
      <div className="bg-white py-12 px-4 md:px-12 rounded-t-3xl shadow-inner">
